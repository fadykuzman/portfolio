...
export default function Home() {
	...
	<Image
						...
						<a href="https://github.com/fadykuzman" className="text-blue-400 hover:text-blue-300" target="_blank" rel="noopener noreferrer">
							<Image
						...
						<a href="https://linkedin.com/in/fadykuzman" className="text-blue-400 hover:text-blue-300" target="_blank" rel="noopener noreferrer">
							<Image
